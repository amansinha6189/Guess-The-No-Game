...
function initGame() {
  ...
  // resct result Display
  // Reset the guesses array and
  // Reset the guess history disply
...
function getRandomNumber() {
  // *CODE GOES BELOW HERE *
  let randomNumber = Math.random(); // always give value between 0(inclusive) and 1(exclusive)
  let wholeNumber = Math.floor(randomNumber * 100); //removes digits after the decimal place
  return wholeNumber;
}
 ...
 * </ul>
 * HINT: use while/for loop and string concatentation to create a list of guesses
 */
